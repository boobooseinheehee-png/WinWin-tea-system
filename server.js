...
// 📌 prod15kStr အသစ်တိုးထားပါသည်
const ProdLog = mongoose.model('ProdLog', new mongoose.Schema({ date: String, prod5kStr: String, prod10kStr: String, prod15kStr: String, laborCost: Number, materialsCost: Number, deliFee: Number, totalExp: Number }));
// 📌 sold15kStr အသစ်တိုးထားပါသည်
const Voucher = mongoose.model('Voucher', new mongoose.Schema({ date: String, name: String, phone: String, address: String, sold5kStr: String, sold10kStr: String, sold15kStr: String, bagFee: Number, discount: Number, totalCost: Number, paidAmount: Number, debt: Number }));
...
app.get('/', (req, res) => res.send("Win Win Tea Server v4.0 Active"));
